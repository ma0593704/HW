...
public class Fitness {
    ...
    public void addSubscription(Subscription subscription){
        for (int i = 0; i < subscriptions.length; i++) {
            ...
            if(subscriptions[i].getSurname().equals(subscription.surname)&&subscriptions[i].getName().equals(subscription.name))throw new IllegalArgumentException("Такой абонемент уже есть");

...
public class Level {
    ...
    public static List<Point> brickCords;
    ...
    public void render(Graphics2D g) {
        ...
        //вот оно
        if (brickDestruction) {
            tiles.get(TileType.EMPTY).render(g, (int) bulletX/32 * SCALED_TILE_SIZE, (int) bulletY/32 * SCALED_TILE_SIZE);
            brickCords.remove(new Point(9 * SCALED_TILE_SIZE, 14 * SCALED_TILE_SIZE));
        }
    }
    ...
    public void destroy(float bulletX, float bulletY, boolean brickDestruction) {
